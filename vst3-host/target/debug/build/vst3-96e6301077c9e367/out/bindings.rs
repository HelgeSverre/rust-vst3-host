...
pub mod Steinberg {
    ...
    pub type int64 = ::std::ffi::c_longlong;
    ...
    pub type char16 = ::std::ffi::c_short;
    ...
    pub mod VirtualKeyCodes_ {
        #[allow(unused_imports)]
        use super::*;
        pub const KEY_BACK: ::std::ffi::c_uint = 1;
        pub const KEY_TAB: ::std::ffi::c_uint = 2;
        pub const KEY_CLEAR: ::std::ffi::c_uint = 3;
        pub const KEY_RETURN: ::std::ffi::c_uint = 4;
        pub const KEY_PAUSE: ::std::ffi::c_uint = 5;
        pub const KEY_ESCAPE: ::std::ffi::c_uint = 6;
        pub const KEY_SPACE: ::std::ffi::c_uint = 7;
        pub const KEY_NEXT: ::std::ffi::c_uint = 8;
        pub const KEY_END: ::std::ffi::c_uint = 9;
        pub const KEY_HOME: ::std::ffi::c_uint = 10;
        pub const KEY_LEFT: ::std::ffi::c_uint = 11;
        pub const KEY_UP: ::std::ffi::c_uint = 12;
        pub const KEY_RIGHT: ::std::ffi::c_uint = 13;
        pub const KEY_DOWN: ::std::ffi::c_uint = 14;
        pub const KEY_PAGEUP: ::std::ffi::c_uint = 15;
        pub const KEY_PAGEDOWN: ::std::ffi::c_uint = 16;
        pub const KEY_SELECT: ::std::ffi::c_uint = 17;
        pub const KEY_PRINT: ::std::ffi::c_uint = 18;
        pub const KEY_ENTER: ::std::ffi::c_uint = 19;
        pub const KEY_SNAPSHOT: ::std::ffi::c_uint = 20;
        pub const KEY_INSERT: ::std::ffi::c_uint = 21;
        pub const KEY_DELETE: ::std::ffi::c_uint = 22;
        pub const KEY_HELP: ::std::ffi::c_uint = 23;
        pub const KEY_NUMPAD0: ::std::ffi::c_uint = 24;
        pub const KEY_NUMPAD1: ::std::ffi::c_uint = 25;
        pub const KEY_NUMPAD2: ::std::ffi::c_uint = 26;
        pub const KEY_NUMPAD3: ::std::ffi::c_uint = 27;
        pub const KEY_NUMPAD4: ::std::ffi::c_uint = 28;
        pub const KEY_NUMPAD5: ::std::ffi::c_uint = 29;
        pub const KEY_NUMPAD6: ::std::ffi::c_uint = 30;
        pub const KEY_NUMPAD7: ::std::ffi::c_uint = 31;
        pub const KEY_NUMPAD8: ::std::ffi::c_uint = 32;
        pub const KEY_NUMPAD9: ::std::ffi::c_uint = 33;
        pub const KEY_MULTIPLY: ::std::ffi::c_uint = 34;
        pub const KEY_ADD: ::std::ffi::c_uint = 35;
        pub const KEY_SEPARATOR: ::std::ffi::c_uint = 36;
        pub const KEY_SUBTRACT: ::std::ffi::c_uint = 37;
        pub const KEY_DECIMAL: ::std::ffi::c_uint = 38;
        pub const KEY_DIVIDE: ::std::ffi::c_uint = 39;
        pub const KEY_F1: ::std::ffi::c_uint = 40;
        pub const KEY_F2: ::std::ffi::c_uint = 41;
        pub const KEY_F3: ::std::ffi::c_uint = 42;
        pub const KEY_F4: ::std::ffi::c_uint = 43;
        pub const KEY_F5: ::std::ffi::c_uint = 44;
        pub const KEY_F6: ::std::ffi::c_uint = 45;
        pub const KEY_F7: ::std::ffi::c_uint = 46;
        pub const KEY_F8: ::std::ffi::c_uint = 47;
        pub const KEY_F9: ::std::ffi::c_uint = 48;
        pub const KEY_F10: ::std::ffi::c_uint = 49;
        pub const KEY_F11: ::std::ffi::c_uint = 50;
        pub const KEY_F12: ::std::ffi::c_uint = 51;
        pub const KEY_NUMLOCK: ::std::ffi::c_uint = 52;
        pub const KEY_SCROLL: ::std::ffi::c_uint = 53;
        pub const KEY_SHIFT: ::std::ffi::c_uint = 54;
        pub const KEY_CONTROL: ::std::ffi::c_uint = 55;
        pub const KEY_ALT: ::std::ffi::c_uint = 56;
        pub const KEY_EQUALS: ::std::ffi::c_uint = 57;
        pub const KEY_CONTEXTMENU: ::std::ffi::c_uint = 58;
        pub const KEY_MEDIA_PLAY: ::std::ffi::c_uint = 59;
        pub const KEY_MEDIA_STOP: ::std::ffi::c_uint = 60;
        pub const KEY_MEDIA_PREV: ::std::ffi::c_uint = 61;
        pub const KEY_MEDIA_NEXT: ::std::ffi::c_uint = 62;
        pub const KEY_VOLUME_UP: ::std::ffi::c_uint = 63;
        pub const KEY_VOLUME_DOWN: ::std::ffi::c_uint = 64;
        pub const KEY_F13: ::std::ffi::c_uint = 65;
        pub const KEY_F14: ::std::ffi::c_uint = 66;
        pub const KEY_F15: ::std::ffi::c_uint = 67;
        pub const KEY_F16: ::std::ffi::c_uint = 68;
        pub const KEY_F17: ::std::ffi::c_uint = 69;
        pub const KEY_F18: ::std::ffi::c_uint = 70;
        pub const KEY_F19: ::std::ffi::c_uint = 71;
        pub const KEY_F20: ::std::ffi::c_uint = 72;
        pub const KEY_F21: ::std::ffi::c_uint = 73;
        pub const KEY_F22: ::std::ffi::c_uint = 74;
        pub const KEY_F23: ::std::ffi::c_uint = 75;
        pub const KEY_F24: ::std::ffi::c_uint = 76;
        pub const KEY_SUPER: ::std::ffi::c_uint = 77;
        pub const VKEY_FIRST_CODE: ::std::ffi::c_uint = 1;
        pub const VKEY_LAST_CODE: ::std::ffi::c_uint = 77;
        pub const VKEY_FIRST_ASCII: ::std::ffi::c_uint = 128;
    }
    pub type KeyModifier = ::std::ffi::c_uint;
    pub mod KeyModifier_ {
        #[allow(unused_imports)]
        use super::*;
        pub const kShiftKey: ::std::ffi::c_uint = 1;
        pub const kAlternateKey: ::std::ffi::c_uint = 2;
    ...
    unsafe impl ::com_scrape_types::Interface for FUnknown {
        ...
        const IID: ::com_scrape_types::Guid = tuid_as_guid(FUnknown_iid);
        #[inline]
    ...
    mod __IPlugViewContentScaleSupport_wrapper {
        ...
        unsafe impl ::com_scrape_types::Interface for IPlugViewContentScaleSupport {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IPlugViewContentScaleSupport_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
    ...
    unsafe impl ::com_scrape_types::Interface for IPlugFrame {
        ...
        const IID: ::com_scrape_types::Guid = tuid_as_guid(IPlugFrame_iid);
        #[inline]
        fn inherits(iid: &::com_scrape_types::Guid) -> bool {
            iid == &Self::IID || FUnknown::inherits(iid)
        }
    ...
    pub mod Vst {
        ...
        pub mod MediaTypes_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kAudio: ::std::ffi::c_uint = 0;
            pub const kEvent: ::std::ffi::c_uint = 1;
            pub const kNumMediaTypes: ::std::ffi::c_uint = 2;
        }
        pub type BusDirections = ::std::ffi::c_uint;
        pub mod BusDirections_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kInput: ::std::ffi::c_uint = 0;
            pub const kOutput: ::std::ffi::c_uint = 1;
        }
        pub type BusTypes = ::std::ffi::c_uint;
        pub mod BusTypes_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kMain: ::std::ffi::c_uint = 0;
            pub const kAux: ::std::ffi::c_uint = 1;
        }
        pub type IoModes = ::std::ffi::c_uint;
        pub mod IoModes_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kSimple: ::std::ffi::c_uint = 0;
            pub const kAdvanced: ::std::ffi::c_uint = 1;
            pub const kOfflineProcessing: ::std::ffi::c_uint = 2;
        }
        pub type RestartFlags = int32;
        pub mod RestartFlags_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kReloadComponent: int32 = 1;
            pub const kIoChanged: int32 = 2;
            pub const kParamValuesChanged: int32 = 4;
            pub const kLatencyChanged: int32 = 8;
            pub const kParamTitlesChanged: int32 = 16;
            pub const kMidiCCAssignmentChanged: int32 = 32;
            pub const kNoteExpressionChanged: int32 = 64;
            pub const kIoTitlesChanged: int32 = 128;
            pub const kPrefetchableSupportChanged: int32 = 256;
            pub const kRoutingInfoChanged: int32 = 512;
            pub const kKeyswitchChanged: int32 = 1024;
            pub const kParamIDMappingChanged: int32 = 2048;
        }
        ...
        pub mod KnobModes_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kCircularMode: KnobMode = 0;
            pub const kRelativCircularMode: KnobMode = 1;
            pub const kLinearMode: KnobMode = 2;
        }
        ...
        pub mod ComponentFlags_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kDistributable: ::std::ffi::c_uint = 1;
            pub const kSimpleModeSupported: ::std::ffi::c_uint = 2;
        }
        pub type SymbolicSampleSizes = ::std::ffi::c_uint;
        pub mod SymbolicSampleSizes_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kSample32: ::std::ffi::c_uint = 0;
            pub const kSample64: ::std::ffi::c_uint = 1;
        }
        pub type ProcessModes = ::std::ffi::c_uint;
        pub mod ProcessModes_ {
            #[allow(unused_imports)]
            use super::*;
            pub const kRealtime: ::std::ffi::c_uint = 0;
        ...
        unsafe impl ::com_scrape_types::Interface for IRemapParamID {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IRemapParamID_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        pub mod ParameterInfo_ {
            ...
            pub mod ParameterFlags_ {
                ...
                pub const kCanAutomate: int32 = 1;
                pub const kIsReadOnly: int32 = 2;
                pub const kIsWrapAround: int32 = 4;
                pub const kIsList: int32 = 8;
                pub const kIsHidden: int32 = 16;
                pub const kIsProgramChange: int32 = 32768;
                pub const kIsBypass: int32 = 65536;
            }
        }
        #[repr(C)]
        #[derive(Copy, Clone)]
        ...
        unsafe impl ::com_scrape_types::Interface for IComponentHandlerSystemTime {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IComponentHandlerSystemTime_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        pub mod FrameRate_ {
            ...
            pub mod FrameRateFlags_ {
                #[allow(unused_imports)]
                use super::*;
                pub const kPullDownRate: ::std::ffi::c_uint = 1;
                pub const kDropRate: ::std::ffi::c_uint = 2;
            }
        }
        mod __Chord_wrapper {
            #[allow(unused_imports)]
        ...
        pub mod Chord_ {
            ...
            pub mod Masks_ {
                #[allow(unused_imports)]
                use super::*;
                pub const kChordMask: ::std::ffi::c_uint = 4095;
                pub const kReservedMask: ::std::ffi::c_uint = 61440;
            }
        }
        ...
        pub mod ProcessContext_ {
            ...
            pub mod StatesAndFlags_ {
                #[allow(unused_imports)]
                use super::*;
                pub const kPlaying: ::std::ffi::c_uint = 2;
                pub const kCycleActive: ::std::ffi::c_uint = 4;
                pub const kRecording: ::std::ffi::c_uint = 8;
                pub const kSystemTimeValid: ::std::ffi::c_uint = 256;
                pub const kContTimeValid: ::std::ffi::c_uint = 131072;
                pub const kProjectTimeMusicValid: ::std::ffi::c_uint = 512;
                pub const kBarPositionValid: ::std::ffi::c_uint = 2048;
                pub const kCycleValid: ::std::ffi::c_uint = 4096;
                pub const kTempoValid: ::std::ffi::c_uint = 1024;
                pub const kTimeSigValid: ::std::ffi::c_uint = 8192;
                pub const kChordValid: ::std::ffi::c_uint = 262144;
                pub const kSmpteValid: ::std::ffi::c_uint = 16384;
        ...
        unsafe impl ::com_scrape_types::Interface for IDataExchangeHandler {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IDataExchangeHandler_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        unsafe impl ::com_scrape_types::Interface for IDataExchangeReceiver {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IDataExchangeReceiver_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        unsafe impl ::com_scrape_types::Interface for IUnitHandler {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IUnitHandler_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        unsafe impl ::com_scrape_types::Interface for IUnitHandler2 {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IUnitHandler2_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        unsafe impl ::com_scrape_types::Interface for IUnitInfo {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IUnitInfo_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        unsafe impl ::com_scrape_types::Interface for IProgramListData {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IProgramListData_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        unsafe impl ::com_scrape_types::Interface for IUnitData {
            ...
            const IID: ::com_scrape_types::Guid = tuid_as_guid(IUnitData_iid);
            #[inline]
            fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                iid == &Self::IID || FUnknown::inherits(iid)
            }
        ...
        pub const SDKVersionString: FIDString = b"VST 3.7.12\0".as_ptr() as *const ::std::ffi::c_char;
        pub const SDKVersionMajor: uint32 = 3;
        pub const SDKVersionMinor: uint32 = 7;
        pub const SDKVersionSub: uint32 = 12;
        pub const SDKVersion: uint32 = 198412;
        ...
        pub const IRemapParamID_iid: TUID = uid(0x2B88021E, 0x6286B646, 0xB49DF76A, 0x5663061C);
        ...
        pub const IComponentHandlerSystemTime_iid: TUID = uid(0xF9E53056, 0xD1554CD5, 0xB7695E1B, 0x7B0F7745);
        ...
        pub const IDataExchangeHandler_iid: TUID = uid(0x36D551BD, 0x6FF54F08, 0xB48E830D, 0x8BD5A03B);
        pub const IDataExchangeReceiver_iid: TUID = uid(0x45A759DC, 0x84FA4907, 0xABCB6175, 0x2FC786B6);
        ...
        pub const IVst3ToVst2Wrapper_iid: TUID = uid(0x29633AEC, 0x1D1C47E2, 0xBB85B97B, 0xD36EAC61);
        ...
        pub mod ChannelContext {
            ...
            pub mod ChannelPluginLocation_ {
                #[allow(unused_imports)]
                use super::*;
                pub const kPreVolumeFader: ::std::ffi::c_uint = 0;
                pub const kPostVolumeFader: ::std::ffi::c_uint = 1;
                pub const kUsedAsPanner: ::std::ffi::c_uint = 2;
            }
            pub type ColorSpec = uint32;
            pub type ColorComponent = uint8;
            #[repr(C)]
            ...
            unsafe impl ::com_scrape_types::Interface for IInfoListener {
                ...
                const IID: ::com_scrape_types::Guid = tuid_as_guid(IInfoListener_iid);
                #[inline]
                fn inherits(iid: &::com_scrape_types::Guid) -> bool {
                    iid == &Self::IID || FUnknown::inherits(iid)
                }
